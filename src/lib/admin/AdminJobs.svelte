<script lang="ts">
  ...
  // externas (Bolsa EPN, Multitrabajos, Computrabajo, Trabajo.org, Indeed, LinkedIn y ats-scrapers,
  ...
  <header class="flex flex-wrap items-start justify-between gap-4">
    <div>
      ...
      <p class="mt-1 max-w-prose text-sm text-ink-2">
        ...
        desde la Bolsa EPN, Multitrabajos, Computrabajo, Trabajo.org, Indeed,
        LinkedIn y ats-scrapers.
      </p>
    </div>
    <button
